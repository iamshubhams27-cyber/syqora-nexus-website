                  ...
                  <div className="relative z-10 my-auto">
                    {project.visualType === 'capello' && (
                      <div className="space-y-1.5 max-w-sm">
                        ...
                        <h4 className="text-3xl sm:text-4xl font-bold text-white font-display leading-none">
                          Beauty, <br />
                ...
                <div className="p-6 sm:p-7 flex flex-col justify-between flex-1 space-y-5">
                  ...
                  <div className="pt-4 border-t border-white/10 flex items-center justify-between gap-3">
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/15 text-xs font-bold text-white flex items-center gap-1.5 transition-colors"
                    >
            ...
            {selectedProject.id === 'capello' && (
              <div className="bg-gradient-to-br from-[#201410] to-[#0f0907] border border-amber-500/30 rounded-2xl p-5 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs text-gray-300 font-medium">Select Package / Service:</label>
                    <select
                      value={selectedService}
                      onChange={(e) => setSelectedService(e.target.value)}
                      className="w-full bg-black/60 border border-amber-500/30 rounded-xl px-3 py-2.5 text-xs sm:text-sm text-white focus:outline-none focus:border-amber-400"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-black font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 hover:from-amber-400 hover:to-amber-500 transition-all"
                  >
